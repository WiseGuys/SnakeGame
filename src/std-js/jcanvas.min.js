...
!function (a, b, c) {
  ...
  function h(a) {
    ...
    for (b in a) {
      Object.prototype.hasOwnProperty.call(a, b) && (c = a[b], "string" === sa(c) && f(c) && "text" !== b && (a[b] = pa(c)));
    }
  ...
  function s(a, b, c) {
    ...
    b.events.mouseout || (a.bind("mouseout.jCanvas", function () {
      ...
      for (d && (b.drag = {}, F(a, b, d, "dragcancel")), c = 0; c < b.layers.length; c += 1) {
  ...
  function J(a, b, c) {
    ...
    for (d in c) {
      if (Object.prototype.hasOwnProperty.call(c, d) && (e = c[d], ta(e) && (c[d] = e.call(a, b, d)), "object" === sa(e) && ua(e))) {
        for (f in e) {
          Object.prototype.hasOwnProperty.call(e, f) && (g = e[f], void 0 !== b[d] && (b[d + "." + f] = b[d][f], c[d + "." + f] = g));
        }
  ...
  function M(a) {
    ...
    for ("array" !== sa(a.start) && (a.start = L(a.start), a.end = L(a.end)), a.now = [], 1 === a.start[3] && 1 === a.end[3] || (c = 4), b = 0; b < c; b += 1) {
  ...
  d.baseDefaults = {
    ...
    return b.name && (b.props && qa(ia, b.props), a.fn[b.name] = function a(d) {
      ...
      for (f = 0; f < j.length; f += 1) {
        e = j[f], (h = g(e)) && (i = new c(d), G(e, i, d, a), m(e, h, i), b.fn.call(e, h, i));
      }
    ...
    var b,
        ...
        g = this,
        h = [];
    if (0 !== g.length) if (b = g[0], c = r(b), d = c.layers, ta(a)) for (f = 0; f < d.length; f += 1) {
      e = d[f], a.call(b, e) && h.push(e);
    } else h = d;
    return h;
    ...
    for (e = 0; e < m.length; e += 1) {
      if (d = a(m[e]), g = r(m[e]), i = a(m[e]).getLayer(b)) {
        ...
        for (j in c) {
          Object.prototype.hasOwnProperty.call(c, j) && (k = c[j], l = sa(k), "object" === l && ua(k) ? (i[j] = qa({}, k), h(i[j])) : "array" === l ? i[j] = k.slice(0) : "string" === l ? 0 === k.indexOf("+=") ? i[j] += pa(k.substr(2)) : 0 === k.indexOf("-=") ? i[j] -= pa(k.substr(2)) : !isNaN(k) && f(k) && "text" !== j ? i[j] = pa(k) : i[j] = k : i[j] = k);
        }
    ...
    for (e = 0; e < i.length; e += 1) {
      d = a(i[e]), f = r(i[e]), g = f.layers, (h = d.getLayer(b)) && (h.index = ra(h, g), g.splice(h.index, 1), g.splice(c, 0, h), c < 0 && (c = g.length + c), h.index = c, F(d, f, h, "move"));
    }
    ...
    for (d = 0; d < h.length; d += 1) {
      c = a(h[d]), e = r(h[d]), f = c.getLayers(), (g = c.getLayer(b)) && (g.index = ra(g, f), f.splice(g.index, 1), delete g._layer, w(c, e, g, {
        name: null
      }), x(c, e, g, {
        groups: null
      }), F(c, e, g, "remove"));
    ...
    for (d = 0; d < i.length; d += 1) {
      for (c = a(i[d]), e = r(i[d]), f = c.getLayers(b), h = 0; h < f.length; h += 1) {
        g = f[h], c.removeLayer(g), h -= 1;
      }
    ...
    for (e = 0; e < g.length; e += 1) {
      d = a(g[e]), f = d.getLayer(b), f.groups && (h = f.groups.slice(0), -1 === ra(c, f.groups) && h.push(c)), d.setLayer(f, {
        groups: h
      });
    }
    ...
    for (e = 0; e < h.length; e += 1) {
      d = a(h[e]), f = d.getLayer(b), f.groups && -1 !== (g = ra(c, f.groups)) && (i = f.groups.slice(0), i.splice(g, 1), d.setLayer(f, {
        groups: i
      }));
    }
    ...
    for (e = 0; e < g.length; e += 1) {
      d = a(g[e]), f = r(g[e]), (b = d.getLayer(b)) && F(d, f, b, c);
    }
    ...
    for (c = 0; c < h.length; c += 1) {
      e = a(h[c]), (d = g(h[c])) && (f = e.getLayer(b), z(e, d, f));
    }
    ...
    for (b = 0; b < e.length; b += 1) {
      g(e[b]) && (d = new c(a), d.layer = !0, G(e[b], d, a));
    }
    ...
    for ("object" === sa(i[2]) ? (i.splice(2, 0, i[2].duration || null), i.splice(3, 0, i[3].easing || null), i.splice(4, 0, i[4].complete || null), i.splice(5, 0, i[5].step || null)) : (void 0 === i[2] ? (i.splice(2, 0, null), i.splice(3, 0, null), i.splice(4, 0, null)) : ta(i[2]) && (i.splice(2, 0, null), i.splice(3, 0, null)), void 0 === i[3] ? (i[3] = null, i.splice(4, 0, null)) : ta(i[3]) && i.splice(3, 0, null)), c = 0; c < h.length; c += 1) {
      b = a(h[c]), g(h[c]) && (d = r(h[c]), (e = b.getLayer(i[0])) && e._method !== a.fn.draw && (f = qa({}, i[1]), f = J(h[c], e, f), I(f, !0), I(e), e.style = Ga.propsObj, a(e).animate(f, {
        duration: i[2],
    ...
    for (c = c || 0, e = 0; e < h.length; e += 1) {
      d = a(h[e]), f = r(h[e]), (g = d.getLayer(b)) && (a(g).delay(c), F(d, f, g, "delay"));
    }
    ...
    for (e = 0; e < h.length; e += 1) {
      d = a(h[e]), f = r(h[e]), (g = d.getLayer(b)) && (a(g).stop(c), F(d, f, g, "stop"));
    }
    ...
    var d,
        ...
        f = this,
        h = new c(b);
    if (Da.drawings[h.type] && "function" !== h.type) f[Da.drawings[h.type]](b);else for (d = 0; d < f.length; d += 1) {
      (e = g(f[d])) && (h = new c(b), G(f[d], h, b, a), h.visible && h.fn && h.fn.call(f[d], e, h));
    }
    return f;
    ...
    for (d = 0; d < f.length; d += 1) {
      (e = g(f[d])) && (null === h.width || null === h.height ? (e.save(), e.setTransform(1, 0, 0, 1, 0, 0), e.clearRect(0, 0, f[d].width, f[d].height), e.restore()) : (G(f[d], h, b, a), q(f[d], e, h, h.width, h.height), e.clearRect(h.x - h.width / 2, h.y - h.height / 2, h.width, h.height), o(e, h)));
    }
    ...
    for (d = 0; d < k.length; d += 1) {
      if (e = g(k[d])) for (h = r(k[d]), f = new c(b), G(k[d], f, b, a), i = 0; i < f.count; i += 1) {
        j(e, h);
      }
    }
    ...
    for (d = 0; d < j.length; d += 1) {
      if (e = g(j[d])) for (h = r(j[d]), f = new c(b), G(j[d], f, b, a), i = 0; i < f.count; i += 1) {
        k(e, h);
      }
    }
    ...
    for (d = 0; d < i.length; d += 1) {
      (e = g(i[d])) && (h = r(i[d]), f = new c(b), G(i[d], f, b, a), f.autosave && j(e, h), R(e, f, h.transforms));
    }
    ...
    for (d = 0; d < i.length; d += 1) {
      (e = g(i[d])) && (h = r(i[d]), f = new c(b), G(i[d], f, b, a), f.autosave && j(e, h), S(e, f, h.transforms));
    }
    ...
    for (d = 0; d < i.length; d += 1) {
      (e = g(i[d])) && (h = r(i[d]), f = new c(b), G(i[d], f, b, a), f.autosave && j(e, h), T(e, f, h.transforms));
    }
    ...
    for (d = 0; d < h.length; d += 1) {
      (e = g(h[d])) && (f = new c(b), G(h[d], f, b, a), f.visible && (q(h[d], e, f, 2 * f.radius), m(h[d], e, f), e.beginPath(), X(h[d], e, f, f), Q(h[d], e, f), p(h[d], e, f)));
    }
    ...
    for (d = 0; d < j.length; d += 1) {
      (e = g(j[d])) && (f = new c(b), G(j[d], f, b, a), f.visible && (q(j[d], e, f, f.width, f.height), m(j[d], e, f), h = f.width * (4 / 3), i = f.height, e.beginPath(), e.moveTo(f.x, f.y - i / 2), e.bezierCurveTo(f.x - h / 2, f.y - i / 2, f.x - h / 2, f.y + i / 2, f.x, f.y + i / 2), e.bezierCurveTo(f.x + h / 2, f.y + i / 2, f.x + h / 2, f.y - i / 2, f.x, f.y - i / 2), Q(j[d], e, f), f.closed = !0, p(j[d], e, f)));
    }
    ...
    for (d = 0; d < r.length; d += 1) {
      if ((e = g(r[d])) && (f = new c(b), G(r[d], f, b, a), f.visible)) {
        for (q(r[d], e, f, 2 * f.radius), m(r[d], e, f), i = 2 * va / f.sides, j = i / 2, h = j + va / 2, k = f.radius * za(j), e.beginPath(), o = 0; o < f.sides; o += 1) {
          l = f.x + f.radius * za(h), n = f.y + f.radius * ya(h), e.lineTo(l, n), f.concavity && (l = f.x + (k + -k * f.concavity) * za(h + j), n = f.y + (k + -k * f.concavity) * ya(h + j), e.lineTo(l, n)), h += i;
        }
    ...
    for (d = 0; d < k.length; d += 1) {
      (e = g(k[d])) && (f = new c(b), G(k[d], f, b, a), f.visible && (q(k[d], e, f, 2 * f.radius), m(k[d], e, f), f.start *= f._toRad, f.end *= f._toRad, f.start -= va / 2, f.end -= va / 2, f.start = U(f.start), f.end = U(f.end), f.end < f.start && (f.end += 2 * va), h = (f.start + f.end) / 2, i = f.radius * f.spread * za(h), j = f.radius * f.spread * ya(h), f.x += i, f.y += j, e.beginPath(), e.arc(f.x, f.y, f.radius, f.start, f.end, f.ccw), e.lineTo(f.x, f.y), Q(k[d], e, f), f.closed = !0, p(k[d], e, f)));
    }
    ...
    for (d = 0; d < h.length; d += 1) {
      (e = g(h[d])) && (f = new c(b), G(h[d], f, b, a), f.visible && (q(h[d], e, f), m(h[d], e, f), e.beginPath(), _(h[d], e, f, f), Q(h[d], e, f), p(h[d], e, f)));
    }
    ...
    for (d = 0; d < h.length; d += 1) {
      (e = g(h[d])) && (f = new c(b), G(h[d], f, b, a), f.visible && (q(h[d], e, f), m(h[d], e, f), e.beginPath(), aa(h[d], e, f, f), Q(h[d], e, f), p(h[d], e, f)));
    }
    ...
    for (d = 0; d < h.length; d += 1) {
      (e = g(h[d])) && (f = new c(b), G(h[d], f, b, a), f.visible && (q(h[d], e, f), m(h[d], e, f), e.beginPath(), ba(h[d], e, f, f), Q(h[d], e, f), p(h[d], e, f)));
    }
    ...
    for (d = 0; d < h.length; d += 1) {
      (e = g(h[d])) && (f = new c(b), G(h[d], f, b, a), f.visible && (q(h[d], e, f), m(h[d], e, f), e.beginPath(), ea(h[d], e, f, f), Q(h[d], e, f), p(h[d], e, f)));
    }
    ...
    for (d = 0; d < v.length; d += 1) {
      if ((e = g(v[d])) && (f = new c(b), G(v[d], f, b, a), f.visible)) {
        if (e.textBaseline = f.baseline, e.textAlign = f.align, fa(v[d], e, f), i = null !== f.maxWidth ? ha(e, f) : f.text.toString().split("\n"), ga(v[d], e, f, i), h && (h.width = f.width, h.height = f.height), q(v[d], e, f, f.width, f.height), m(v[d], e, f), t = f.x, "left" === f.align ? f.respectAlign ? f.x += f.width / 2 : t -= f.width / 2 : "right" === f.align && (f.respectAlign ? f.x -= f.width / 2 : t += f.width / 2), f.radius) for (l = pa(f.fontSize), null === f.letterSpacing && (f.letterSpacing = l / 500), k = 0; k < i.length; k += 1) {
          for (e.save(), e.translate(f.x, f.y), j = i[k], f.flipArcText && (p = j.split(""), p.reverse(), j = p.join("")), n = j.length, e.rotate(-va * f.letterSpacing * (n - 1) / 2), s = 0; s < n; s += 1) {
            r = j[s], 0 !== s && e.rotate(va * f.letterSpacing), e.save(), e.translate(0, -f.radius), f.flipArcText && e.scale(-1, -1), e.fillText(r, 0, 0), "transparent" !== f.fillStyle && (e.shadowColor = "transparent"), 0 !== f.strokeWidth && e.strokeText(r, 0, 0), e.restore();
          }
    ...
    for (i = 0; i < v.length; i += 1) {
      h = v[i], (j = g(v[i])) && (k = r(v[i]), l = new c(d), p = G(v[i], l, d, b), l.visible && (u = l.source, t = u.getContext, u.src || t ? s = u : u && (w[u] && w[u].complete ? s = w[u] : (s = new ka(), u.match(/^data:/i) || (s.crossOrigin = l.crossOrigin), s.src = u, w[u] = s)), s && (s.complete || t ? f(h, j, k, l, p)() : (s.onload = f(h, j, k, l, p), s.src = s.src))));
    }
    ...
    var e,
        ...
        k,
        l = this;
    return e = g(l[0]), e ? (f = new c(b), k = f.source, ta(k) ? (h = a("<canvas />")[0], h.width = f.width, h.height = f.height, i = g(h), k.call(h, i), d()) : (i = k.getContext, k.src || i ? h = k : (h = new ka(), k.match(/^data:/i) || (h.crossOrigin = f.crossOrigin), h.src = k), h.complete || i ? d() : (h.onload = d, h.src = h.src))) : j = null, j;
    ...
    for (e = 0; e < n.length; e += 1) {
      if (d = n[e], (f = g(d)) && (h = new c(b), G(d, h, b, a), q(n[e], f, h, h.width, h.height), null !== h.width && null !== h.height || (h.width = d.width, h.height = d.height, h.x = h.width / 2, h.y = h.height / 2), 0 !== h.width && 0 !== h.height)) {
        if (j = f.getImageData(h.x - h.width / 2, h.y - h.height / 2, h.width, h.height), k = j.data, m = k.length, h.each) for (l = 0; l < m; l += 4) {
          i = {
            r: k[l],
            g: k[l + 1],
            b: k[l + 2],
            a: k[l + 3]
          }, h.each.call(d, i, h), k[l] = i.r, k[l + 1] = i.g, k[l + 2] = i.b, k[l + 3] = i.a;
        }
