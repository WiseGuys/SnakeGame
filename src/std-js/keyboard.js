...
$(document).keydown(function (event) {
   ...
   */
  var newDirection = event.key.toLowerCase().replace(/(arrow)/i, "");
  /*
  ...
  if ($.inArray(newDirection, allowedDirections[players.users[0].direction]) !== -1) players.users[0].direction = newDirection;
});